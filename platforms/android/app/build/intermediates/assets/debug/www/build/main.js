...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_auth__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__parking_parking__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_launch_navigator__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tabs_tabs__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_background_mode__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_rxjs_add_operator_take__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_rxjs_add_operator_take___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_rxjs_add_operator_take__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_app_version__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_firebase__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_storage__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__addcarpark_addcarpark__ = __webpack_require__(252);
...
var CarparkPage = (function () {
        ...
        Platforms.ready().then(function () {
            _this.parkaht.authState.take(1).subscribe(function (data) {
                if (data) {
                    ...
                    //console.log("bg");
                    _this.backgroundMode.on('activate').take(1).subscribe(function () {
                        _this.bgnotiFunction();
                    });
    ...
    CarparkPage.prototype.setdefault = function () {
        ...
        this.storage.get('Version').then(function (datav) {
            if (datav == null || datav == undefined) {
                ...
                _this.storage.set('Version', "1.0.7");
            }
        });
        var version;
            ...
            _this.parkaht.authState.take(1).subscribe(function (data) {
                ...
                if (id == 0) {
                    _this.firebaseservice.login(_this.userp)
                        ...
                        _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_10__tabs_tabs__["a" /* TabsPage */], { key: ref.key });
                    });
                }
            });
        });
    ...
    CarparkPage.prototype.bgnotiFunction = function () {
        ...
        this.parkaht.authState.subscribe(function (datae) {
            if (datae) {
                _this.db.list("/Parking-list/PA/-LK0dEgrvK9jrDvXWAxP/").snapshotChanges().subscribe(function (res) {
                    var items = [];
                    res.forEach(function (item) {
                        items.push(item.payload.val());
                    });
                    var query = __WEBPACK_IMPORTED_MODULE_14_firebase__["database"]().ref('notification').orderByChild('email').equalTo(datae.email);
                            ...
                            snapshot.forEach(function (childSnapshot) {
                                ...
                                if (itemdata.name == items[1]) {
                                    ...
                                    if (items[3] == true) {
                                        ...
                                        _this.db.list("/notification/").remove(keys);
                                        _this.time.uid = itemdata.email;
                                        _this.time.parkname = itemdata.name;
                                        _this.time.status = items[3];
                ...
                _this.db.list("/Parking-list/PA/-LK0dEgtIgTguejdK7uP/").snapshotChanges().subscribe(function (res) {
                    var items = [];
                    res.forEach(function (item) {
                        items.push(item.payload.val());
                    });
                ...
                _this.db.list("/Parking-list/PA/-LK0dEgulx-RBDKZyHCd").snapshotChanges().subscribe(function (res) {
                    var items = [];
                    res.forEach(function (item) {
                        items.push(item.payload.val());
                    });
                ...
                _this.db.list("/Parking-list/PA/-LK0dEgvLiv6YVFa2uNO").snapshotChanges().subscribe(function (res) {
                    var items = [];
                    res.forEach(function (item) {
                        items.push(item.payload.val());
                    });
                ...
                _this.db.list("/Parking-list/PA/-LK0dEgwJ04bq3sGOTax").snapshotChanges().subscribe(function (res) {
                    var items = [];
                    res.forEach(function (item) {
                        items.push(item.payload.val());
                    });
                ...
                _this.db.list("/Parking-list/PA/-LK0dEgy3nox7S14RBzz").snapshotChanges().subscribe(function (res) {
                    var items = [];
                    res.forEach(function (item) {
                        items.push(item.payload.val());
                    });
    ...
    CarparkPage.prototype.addpark = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_16__addcarpark_addcarpark__["a" /* AddcarparkPage */]);
    };
    ...
    CarparkPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_9__ionic_native_local_notifications__["a" /* LocalNotifications */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_15__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_13__ionic_native_app_version__["a" /* AppVersion */],
            __WEBPACK_IMPORTED_MODULE_6__providers_firebase_service_firebase_service__["a" /* FirebaseServiceProvider */], __WEBPACK_IMPORTED_MODULE_11__ionic_native_background_mode__["a" /* BackgroundMode */]])
    ], CarparkPage);
    return CarparkPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_background_mode__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__parking_parking__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_angularfire2_auth__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_app_version__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_local_notifications__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ionic_angular_navigation_nav_params__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_ionic_angular_components_toast_toast_controller__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__carpark_carpark__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_launch_navigator__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_firebase__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__about_about__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_splash_screen__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular_components_toast_toast_controller__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angularfire2_auth__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_home__ = __webpack_require__(117);
...
var TimelinePage = (function () {
    function TimelinePage(tosat, afb, navCtrl, navParams, platform, splashScreen, homeaut, firebaseservice) {
        ...
        */
        ...
        this.homeaut.authState.subscribe(function (datae) {
            if (datae) {
                _this.afb.list("/Timeline-list/").snapshotChanges().subscribe(function (res1) {
                    var itemes = [];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_code_push__ = __webpack_require__(360);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_app_version__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__translate_translate__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__angular_http__ = __webpack_require__(364);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__about_about__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_background_mode__ = __webpack_require__(118);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__carpark_carpark__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_launch_navigator__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__node_modules_ionic_angular_platform_platform__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_local_notifications__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_photo_viewer__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_firebase__ = __webpack_require__(79);
    ...
    ParkingPage.prototype.mycar = function () {
        ...
        this.homeaut.authState.subscribe(function (data) {
            if (data) {
                ...
                //   }
                // })
                _this.db.list("/notification/").snapshotChanges().subscribe(function (res1) {
                    var i = 0, parking = 0;
                    res1.forEach(function (park2) {
                        console.log(park2);
                        var standpark = park2.payload.val();
                        var standparkkey = park2.key;
                        if (standpark.email == data.email) {
                            _this.standby = standpark.name;
                        }
                        else {
                            _this.standby = null;
                        }
            ...
            var alert = _this.alertCtrl.create({
                ...
                buttons: [{
                        ...
                        handler: function (datae) {
                            if (PA1 == false) {
                                var querypark_1 = __WEBPACK_IMPORTED_MODULE_13_firebase__["database"]().ref('Parking-list/PA/');
                                var query = __WEBPACK_IMPORTED_MODULE_13_firebase__["database"]().ref('notification').orderByChild('email').equalTo(data.email);
                                query.once('value', function (snapshot) {
                                    if (snapshot.val()) {
                                        snapshot.forEach(function (childSnapshot) {
                                            var keys = childSnapshot.key;
                                            ...
                                            if (itemdata.name == name) {
                                                ...
                                                var alert2 = _this.alertCtrl.create({
                                                    ...
                                                    buttons: [{
                                                            ...
                                                            handler: function (dataea) {
                                                                _this.db.list("/notification/").remove(keys);
                                                                _this.standin.email = data.email;
                                                                _this.standin.name = name;
                                                                _this.db.list("/notification/").push(_this.standin);
                                                                querypark_1.orderByChild('status').equalTo(false).once('value', function (snapshots) {
                                                                    if (snapshots.val()) {
                                                                        _this.time.datetime = _this.formateDate();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__ = __webpack_require__(133);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TranslatePage = (function () {
    ...
    TranslatePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-translate',template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\translate\translate.html"*/'<!--\n  Generated template for the TranslatePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n<ion-navbar color="darklight" hideBackButton>\n    <ion-title> {{"Language" | translate}}</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n<ion-list radio-group [(ngModel)]="relationship">\n  <ion-item (click)="changeLanguage(\'en\')">\n    <ion-label>English</ion-label>\n  </ion-item>\n  <ion-item (click)="changeLanguage(\'th\')">\n    <ion-label>Thai</ion-label>\n  </ion-item>\n</ion-list>\n</ion-content>\n\n<ion-footer>\n  <button class="bottom" ion-button clear full color="dark"(click)="back()">{{"Back" | translate}}</button>\n</ion-footer>'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\translate\translate.html"*/,
        }),
...
var GetpicPage = (function () {
    ...
    GetpicPage = GetpicPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-getpic',template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\getpic\getpic.html"*/'<!--\n  Generated template for the GetpicPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar  color="darklight"  hideBackButton>\n    <ion-title>{{"Parking" | translate}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content   >\n<div style="margin-top:50px;">\n<img src="{{Ober}}" imageViewer/>\n</div>\n</ion-content>\n<ion-footer>\n	<button  ion-button clear full color="dark" (click)="back()">{{"Back" | translate}}</button>\n</ion-footer>\n \n\n'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\getpic\getpic.html"*/,
        }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddcarparkPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_firebase_service_firebase_service__ = __webpack_require__(43);
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
 ...
 * Ionic pages and navigation.
 */
var AddcarparkPage = (function () {
    function AddcarparkPage(db, getcamera, FirebaseServiceProvider, navCtrl, navParams, alertCtrl) {
        this.db = db;
    ...
    AddcarparkPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad NotificationPage');
    };
    AddcarparkPage.prototype.getpicture = function () {
        var _this = this;
        var options = {
            targetWidth: 320,
            targetHeight: 240,
        ...
        this.getcamera.getPicture(options).then(function (imageData) {
            // imageData is either a base64 encoded string or a file URI
            // If it's base64 (DATA_URL):
            var cam_base64 = 'data:image/jpeg;base64,' + imageData;
            _this.picture = cam_base64;
        }, function (err) {
            // Handle error
        });
    };
    AddcarparkPage.prototype.camera = function () {
        var _this = this;
        var options = {
            targetWidth: 320,
            targetHeight: 240,
    ...
    AddcarparkPage.prototype.addParking = function (item) {
        var _this = this;
        console.log(item);
        var namess;
        ...
        if (this.picture) {
            var pic = __WEBPACK_IMPORTED_MODULE_2_firebase__["storage"]().ref("park/" + this.item.name);
            pic.putString(this.picture, 'data_url').then(function (data) {
                data.ref.getDownloadURL().then(function (da) {
                    _this.item.url = da;
                    _this.FirebaseServiceProvider.addPark(item);
                });
            });
        }
        else {
    ...
    AddcarparkPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addcarpark',template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\addcarpark\addcarpark.html"*/'<!--\n  Generated template for the AddParkingPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n \n<ion-header>\n<ion-navbar color="darklight" hideBackButton>\n<ion-title> \nAddParking\n</ion-title>\n</ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n<ion-item>\n  <ion-label>Name</ion-label>\n  <ion-input  [(ngModel)]="name" placeholder="A" ></ion-input>\n</ion-item>\n<ion-item>\n  <ion-label>slots</ion-label>\n  <ion-input [(ngModel)]="item.slots" placeholder="6"></ion-input>\n</ion-item>\n<ion-item>\n  <ion-label>location</ion-label>\n  <ion-input [(ngModel)]="item.location" placeholder="TC1 RMUTL"></ion-input>\n</ion-item>\n<ion-item>\n <ion-label>Picture</ion-label>\n\n   <ion-label align="right"><h1> <ion-icon name="md-image" style="margin-right:15px" (click)="getpicture()"></ion-icon> <ion-icon name="md-camera" (click)="camera()"></ion-icon></h1></ion-label>\n   \n</ion-item>\n \n<div  text-center>\n<img src="{{picture}}"/>\n</div>\n \n<button ion-button block clear (click)="addParking(item)">add</button>\n</ion-content>\n'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\addcarpark\addcarpark.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_angularfire2_database__["a" /* AngularFireDatabase */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__["a" /* Camera */],
            __WEBPACK_IMPORTED_MODULE_5__providers_firebase_service_firebase_service__["a" /* FirebaseServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], AddcarparkPage);
    return AddcarparkPage;
}());

//# sourceMappingURL=addcarpark.js.map
...
var map = {
	...
	"../pages/addcarpark/addcarpark.module": [
		744,
		13
	],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_filter__ = __webpack_require__(99);
...
var FirebaseServiceProvider = (function () {
    function FirebaseServiceProvider(db, auth) {
        ...
        this.notificationlist = this.db.list("/notification/");
    ...
    FirebaseServiceProvider.prototype.getnotifi = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_launch_navigator__ = __webpack_require__(102);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LaunchnavigatePage = (function () {
    ...
    LaunchnavigatePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-launchnavigate',template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\launchnavigate\launchnavigate.html"*/'<!--\n  Generated template for the LaunchnavigatePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Launchnavigate</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\launchnavigate\launchnavigate.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_location_track__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_geolocation__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_filter__ = __webpack_require__(99);
...
var NavigatePage = (function () {
    ...
    NavigatePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-navigate',template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\navigate\navigate.html"*/'<!--\n  Generated template for the NavigatePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n  <p>latigut :{{ lat }}</p>\n<p>lontigut : {{ long }}</p>\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title></ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n\n<div #map id="map"></div>\n</ion-content>\n'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\navigate\navigate.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_firebase_service_firebase_service__ = __webpack_require__(43);
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
...
var NotificationPage = (function () {
    ...
    NotificationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-notification',template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\notification\notification.html"*/'<!--\n  Generated template for the AddParkingPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>AddParking</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n<ion-item>\n  <ion-label>Name</ion-label>\n  <ion-input  [(ngModel)]="name" placeholder="A" ></ion-input>\n</ion-item>\n<ion-item>\n  <ion-label>slots</ion-label>\n  <ion-input [(ngModel)]="item.slots" placeholder="6"></ion-input>\n</ion-item>\n<ion-item>\n  <ion-label>location</ion-label>\n  <ion-input [(ngModel)]="item.slots" placeholder="6"></ion-input>\n</ion-item>\n<ion-item>\n  <ion-label>picture</ion-label>\n  <ion-icon name="md-image"></ion-icon> <ion-icon name="md-camera"></ion-icon>\n</ion-item>\n {{item | json}}\n<button ion-button block clear (click)="addParking(item)">add</button>\n</ion-content>\n'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\pages\notification\notification.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_angularfire2_firestore__ = __webpack_require__(602);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_notification_notification__ = __webpack_require__(441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_parking_parking__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_navigate_navigate__ = __webpack_require__(440);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_mycar_mycar__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_location_track__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_app_version__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_launchnavigate_launchnavigate__ = __webpack_require__(439);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_http__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_local_notifications__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_carpark_carpark__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_facebook__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_photo_viewer__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ngx_translate_core__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ngx_translate_http_loader__ = __webpack_require__(645);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_code_push__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_google_plus__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_login_login__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26_angularfire2_auth__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_angularfire2_database__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__ionic_native_launch_navigator__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__ionic_native_background_mode__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_about_about__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_setting_setting__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_tabs_tabs__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__angular_common_http__ = __webpack_require__(646);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_getpic_getpic__ = __webpack_require__(251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_addcarpark_addcarpark__ = __webpack_require__(252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_ionic_img_viewer__ = __webpack_require__(648);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__ionic_native_status_bar__ = __webpack_require__(417);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__pages_translate_translate__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__ionic_native_splash_screen__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__ionic_native_camera__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pipes_group_by_group_by__ = __webpack_require__(739);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_44__pipes_group_by_group_by__["a" /* GroupByPipe */],
                ...
                __WEBPACK_IMPORTED_MODULE_32__pages_about_about__["a" /* AboutPage */], __WEBPACK_IMPORTED_MODULE_36__pages_getpic_getpic__["a" /* GetpicPage */], __WEBPACK_IMPORTED_MODULE_37__pages_addcarpark_addcarpark__["a" /* AddcarparkPage */],
                __WEBPACK_IMPORTED_MODULE_40__pages_translate_translate__["a" /* TranslatePage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/addcarpark/addcarpark.module#AddcarparkPageModule', name: 'AddcarparkPage', segment: 'addcarpark', priority: 'low', defaultHistory: [] },
                ...
                __WEBPACK_IMPORTED_MODULE_38_ionic_img_viewer__["a" /* IonicImageViewerModule */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_30__ionic_native_geolocation__["a" /* Geolocation */], __WEBPACK_IMPORTED_MODULE_44__pipes_group_by_group_by__["a" /* GroupByPipe */],
                __WEBPACK_IMPORTED_MODULE_11__providers_location_track__["a" /* LocationTracker */], __WEBPACK_IMPORTED_MODULE_42__ionic_native_camera__["a" /* Camera */],
                ...
                __WEBPACK_IMPORTED_MODULE_43__providers_firebase_service_firebase_service__["a" /* FirebaseServiceProvider */], __WEBPACK_IMPORTED_MODULE_21__ionic_native_code_push__["a" /* CodePush */], __WEBPACK_IMPORTED_MODULE_12__ionic_native_app_version__["a" /* AppVersion */], __WEBPACK_IMPORTED_MODULE_18__ionic_native_photo_viewer__["a" /* PhotoViewer */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__node_modules_angularfire2_auth__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__ = __webpack_require__(133);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\Pre-pro\blackup\20-14\version2\carpark\src\app\app.html"*/'<!--<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n  Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus \n<ion-nav [root]="HomePage" #content swipeBackEnabled="false"></ion-nav>--> \n<ion-nav [root]="rootPage"></ion-nav>'/*ion-inline-end:"E:\Pre-pro\blackup\20-14\version2\carpark\src\app\app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_firebase_service_firebase_service__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_facebook__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_storage__ = __webpack_require__(71);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__carpark_carpark__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angularfire2_database__ = __webpack_require__(23);
