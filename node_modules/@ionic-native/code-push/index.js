...
var CodePush = (function (_super) {
    ...
    /**
       ...
       * @returns {Promise<ILocalPackage>}
       */
    CodePush.prototype.getCurrentPackage = /**
       * Get the current package information.
       *
       * @returns {Promise<ILocalPackage>}
       */
    ...
    /**
       ...
       * @returns {Promise<ILocalPackage>}
       */
    CodePush.prototype.getPendingPackage = /**
       * Gets the pending package information, if any. A pending package is one that has been installed but the application still runs the old code.
       * This happens only after a package has been installed using ON_NEXT_RESTART or ON_NEXT_RESUME mode, but the application was not restarted/resumed yet.
       * @returns {Promise<ILocalPackage>}
       */
    ...
    /**
       ...
       * @returns {Promise<IRemotePackage>}
       */
    CodePush.prototype.checkForUpdate = /**
       * Checks with the CodePush server if an update package is available for download.
       *
       * @param {string} [deploymentKey] Optional deployment key that overrides the config.xml setting.
       * @returns {Promise<IRemotePackage>}
    ...
    /**
       ...
       * @returns {Promise<void>}
       */
    CodePush.prototype.notifyApplicationReady = /**
       * Notifies the plugin that the update operation succeeded and that the application is ready.
       * Calling this function is required on the first run after an update. On every subsequent application run, calling this function is a noop.
       * If using sync API, calling this function is not required since sync calls it internally.
       *
    ...
    /**
       ...
       * @returns {Promise<void>}
       */
    CodePush.prototype.restartApplication = /**
       * Reloads the application. If there is a pending update package installed using ON_NEXT_RESTART or ON_NEXT_RESUME modes, the update
       * will be immediately visible to the user. Otherwise, calling this function will simply reload the current version of the application.
       * @returns {Promise<void>}
       */
    ...
    CodePush.prototype.sync = /**
       ...
       *
       */
    function (syncOptions, downloadProgress) {
        return;
    };
    CodePush.decorators = [
        { type: Injectable },
