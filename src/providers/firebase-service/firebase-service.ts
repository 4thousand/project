...
import { Parking, Profileuser, Timeline, Loglogin, Parkinglist, Carpark, stand } from '../../model/parking/parking.model';
...
export class FirebaseServiceProvider {
  ...
  private notificationlist = this.db.list<stand>(`/notification/`)
